export function ModrinthIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" fill-rule="evenodd" stroke-linejoin="round"
             stroke-miterlimit="1.5" clip-rule="evenodd" viewBox="0 0 100 100" width="20" height="20"><path fill="none" d="M0 0h100v100H0z"/>
            ...
            <g clip-path="url(#b)"><path fill="
#00d845" d="M50 0c27.596 0 50 22.404 50 50s-22.404 50-50 50S0 77.596 0 50 22.404 0 50 0Zm0 9c22.629 0 41 18.371 41 41S72.629 91 50 91 9 72.629 9 50 27.371 9 50 9Z"/></g>
            ...
            <g clip-path="url(#c)"><path fill="none" stroke="
#00d845" stroke-width="9" d="M50 50 5.171 75.882"/></g>
            ...
            <g clip-path="url(#d)"><path fill="none" stroke="
#00d845" stroke-width="9" d="m50 50 50-13.397"/></g>
            <path fill="
#00d845"
