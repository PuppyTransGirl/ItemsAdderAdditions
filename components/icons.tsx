export function ModrinthIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" strokeLinejoin="round"
             strokeMiterlimit={1.5} clipRule="evenodd" viewBox="0 0 100 100" width="20" height="20">
            ...
            <g clipPath="url(#a)"><path fill="#00d845" d="M50 17c18.207 0 32.988 14.787 32.988 33S68.207 83 50 83 17.012 68.213 17.012 50 31.793 17 50 17Zm0 9c13.24 0 23.988 10.755 23.988 24S63.24 74 50 74 26.012 63.245 26.012 50 36.76 26 50 26Z"/></g>
            <clipPath id="b"><path d="M0 0v46h50l1.368.241L99 63.578l-2.736 7.517L49.295 54H0v46h100V0H0Z"/></clipPath>
            <g clipPath="url(#b)"><path fill="#00d845" d="M50 0c27.596 0 50 22.404 50 50s-22.404 50-50 50S0 77.596 0 50 22.404 0 50 0Zm0 9c22.629 0 41 18.371 41 41S72.629 91 50 91 9 72.629 9 50 27.371 9 50 9Z"/></g>
            ...
            <g clipPath="url(#c)"><path fill="none" stroke="#00d845" strokeWidth={9} d="M50 50 5.171 75.882"/></g>
            ...
            <g clipPath="url(#d)"><path fill="none" stroke="#00d845" strokeWidth={9} d="m50 50 50-13.397"/></g>
...
export function SpigotIcon() {
    return (
        <img src="https://static.spigotmc.org/img/spigot.png" width="20" height="20" alt="SpigotMC"/>
    );
}