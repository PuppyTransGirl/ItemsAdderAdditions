...
public final class BytePacketListener_v26_1_1 {
    ...
    private static final class ByteChannelDupeHandler extends ChannelDuplexHandler {
        ...
        private static PacketListener_v26_1_1.ChannelDupeHandler getDupeHandler(
                ChannelHandlerContext ctx
        ) {
            return (PacketListener_v26_1_1.ChannelDupeHandler) ctx.pipeline()
                            ...
                            if (itemCount > 0) {
                                ...
                                if (itemId == itemRegistry.getId(Items.PAINTING)
                                    ...
                                    if (componentTypeId == dataComponentRegistry.getId(DataComponents.PAINTING_VARIANT)) {
                                        ...
                                        PacketListener_v26_1_1.ChannelDupeHandler dupeHandler = getDupeHandler(ctx);
                                        if (dupeHandler != null) {
