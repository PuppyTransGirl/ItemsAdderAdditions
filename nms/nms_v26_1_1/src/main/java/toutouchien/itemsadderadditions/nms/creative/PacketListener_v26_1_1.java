...
@NullMarked
public final class PacketListener_v26_1_1 {
    /**
    ...
    private PacketListener_v26_1_1() {
     ...
     *
     * <p>Must be called <em>before</em> {@link BytePacketListener_v26_1_1#inject(Plugin)} so that
     * {@code "iaadditions_packet_listener"} already exists in the pipeline
     * when {@code BytePacketListener_v26_1_1} looks it up.
     */
