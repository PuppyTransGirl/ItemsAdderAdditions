...
import toutouchien.itemsadderadditions.nms.painting.RegistryInjector_v1_21_11;

import java.util.*;

@NullMarked
final class NmsPaintingHandler_v1_21_11 implements INmsPaintingHandler {
    ...
    public void injectPaintingVariants(Collection<NmsPaintingVariant> variants) {
        RegistryInjector_v1_21_11.injectPaintingVariants(variants);
    }
