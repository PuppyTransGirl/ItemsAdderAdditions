...
@NullMarked
public final class RegistryInjector_v1_21_11 {
    ...
    private RegistryInjector_v1_21_11() {
    ...
    public static void injectPaintingVariants(Collection<NmsPaintingVariant> variants) {
        ...
        try {
            for (NmsPaintingVariant definition : variants) {
                ...
                Identifier key = identifier(definition.variantId());
    ...
    private static boolean replaceVariant(
        ...
        try {
            ...
            Log.error(TAG, "Failed to bind custom painting variant '" + key.identifier() + "'", e);
            return false;
        }
    }
