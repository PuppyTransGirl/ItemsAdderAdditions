...
public final class PacketListener_v1_21_7 {
     ...
     * Populated during {@link #updateCache} so that {@link BytePacketListener_v1_21_7}
    ...
    private PacketListener_v1_21_7() {
     ...
     *
     * <p>Must be called <em>before</em> {@link BytePacketListener_v1_21_7#inject(Plugin)} so that
     * {@code "iaadditions_packet_listener"} already exists in the pipeline
     * when {@code BytePacketListener_v1_21_7} looks it up.
     */
