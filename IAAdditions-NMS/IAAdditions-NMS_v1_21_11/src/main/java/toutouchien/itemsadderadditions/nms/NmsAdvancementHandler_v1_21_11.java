...
@NullMarked
public final class NmsAdvancementHandler_v1_21_11 implements INmsAdvancementHandler {
    ...
    static {
        try {
            ...
            throw new RuntimeException("NmsAdvancementHandler_v1_21_11 init failed", e);
        }
    }
    ...
    private static void broadcastRemoved(Set<Identifier> ids) {
        ClientboundUpdateAdvancementsPacket packet = new ClientboundUpdateAdvancementsPacket(
