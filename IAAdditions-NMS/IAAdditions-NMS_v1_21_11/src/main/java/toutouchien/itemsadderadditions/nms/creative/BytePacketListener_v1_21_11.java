...
public final class BytePacketListener_v1_21_11 {
    /**
    ...
    private static final class ByteChannelDupeHandler extends ChannelDuplexHandler {
        ...
        /**
         * Returns the {@link PacketListener_v1_21_11.ChannelDupeHandler} from the pipeline, or {@code null} if absent.
         *
         * @param ctx the channel handler context
         * @return the dupe handler, or {@code null}
         */
        private static PacketListener_v1_21_11.ChannelDupeHandler getDupeHandler(
                ChannelHandlerContext ctx
        ) {
            return (PacketListener_v1_21_11.ChannelDupeHandler) ctx.pipeline()
