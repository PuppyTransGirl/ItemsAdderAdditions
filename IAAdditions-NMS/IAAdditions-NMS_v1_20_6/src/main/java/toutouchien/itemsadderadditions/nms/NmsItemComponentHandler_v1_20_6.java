...
@NullMarked
final class NmsItemComponentHandler_v1_20_6 implements INmsItemComponentHandler {
    @Override
    ...
    public GenericComponentResult apply(ItemStack itemStack, String normalizedKey, ComponentValue value, String itemId) {
        return GenericComponentResult.failure(
                "Generic NMS components require Minecraft 1.21.3 or higher. Current: 1.20.6"
        );
    }
}
