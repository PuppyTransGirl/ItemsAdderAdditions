...
@NullMarked
public final class NmsAdvancementHandler_v1_21_4 implements INmsAdvancementHandler {
    ...
    static {
        try {
            ...
            throw new RuntimeException("NmsAdvancementHandler_v1_21_4 init failed", e);
        }
    }
