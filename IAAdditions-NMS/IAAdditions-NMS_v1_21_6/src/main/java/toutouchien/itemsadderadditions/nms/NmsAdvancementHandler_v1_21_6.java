...
@NullMarked
public final class NmsAdvancementHandler_v1_21_6 implements INmsAdvancementHandler {
    ...
    static {
        try {
            ...
            throw new RuntimeException("NmsAdvancementHandler_v1_21_6 init failed", e);
        }
    }
