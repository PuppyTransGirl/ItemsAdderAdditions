...
import toutouchien.itemsadderadditions.nms.painting.RegistryInjector_v1_21_6;

import java.util.*;

@NullMarked
final class NmsPaintingHandler_v1_21_6 implements INmsPaintingHandler {
    ...
    public void injectPaintingVariants(Collection<NmsPaintingVariant> variants) {
        RegistryInjector_v1_21_6.injectPaintingVariants(variants);
    }
