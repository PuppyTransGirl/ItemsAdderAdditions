 ...
 * RecipesConfigsLoader into itemsadder/m/rn, where FC is the crafting recipe list.
 * FD is the cooking recipe list and must be left for ItemsAdder to register.
 */
public final class CraftingRecipeBypassPatch_IA_4_0_17 extends MethodInjectPatch {
    ...
    protected void inject(GeneratorAdapter ga) {
        ga.loadThis();
        ga.getField(T_LOADER, "FC", T_LIST);
