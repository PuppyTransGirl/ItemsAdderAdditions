...
description: Add campfire cooking recipes for ItemsAdder, MMOItems, or vanilla Minecraft items. Defined directly in your content YML files, no extra recipe files needed.
version: "1.0.3"
---
...
Required. The input item for the recipe. Use a vanilla material, an ItemsAdder item, or an MMOItems item.
