...
description: Add advanced crafting table recipes with ItemsAdder items, MMOItems items, vanilla items, vanilla tags, exact amounts, durability requirements, shapeless support, and completion sounds/commands via iaa_crafting_table.
version: "1.0.7"
---
...
Ingredients can additionally use vanilla tags like `#minecraft:planks`. Tags are not valid as results or replacement items.
