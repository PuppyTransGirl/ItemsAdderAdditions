...
description: Add advanced crafting table recipes with ItemsAdder items, MMOItems items, vanilla items, vanilla tags, exact amounts, durability requirements, and shapeless support via iaa_crafting_table.
version: "1.0.7"
---
