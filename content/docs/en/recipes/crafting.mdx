...
description: Add advanced ItemsAdder crafting table recipes with ingredient tags, exact amounts, durability requirements, and shapeless support via iaa_crafting_table.
version: "1.0.7"
---
