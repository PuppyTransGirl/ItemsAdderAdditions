---
title: Crafting
description: Add advanced crafting recipes with ItemsAdder items, MMOItems items, vanilla items, vanilla tags, exact amounts, durability requirements, shapeless support, and completion sounds/commands.
version: "1.0.10"
---
