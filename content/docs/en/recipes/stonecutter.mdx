---
title: Stonecutter
description: Add stonecutter recipes with optional sounds and commands.
version: "1.0.3"
---
...
Required. The input item shown in the stonecutter. Use a vanilla material, an ItemsAdder item, or an MMOItems item. See [IDs](/en/docs/compatibility/ids).
