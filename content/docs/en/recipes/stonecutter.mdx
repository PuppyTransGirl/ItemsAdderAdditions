---
title: Stonecutter
description: Add stonecutter recipes for custom or vanilla Minecraft items using ItemsAdder. Defined directly in your content YML files, no extra recipe files needed.
version: "1.0.7"
---
