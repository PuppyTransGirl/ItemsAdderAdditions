...
Crafting recipe ingredients are different: `iaa_crafting_table` tag ingredients use Bukkit's vanilla item/block tags only. They do not resolve ItemsAdderAdditions custom tags.
