...
`iaa_crafting_table` ingredients are a special case: tag ingredients use Bukkit vanilla item/block tags only. They do not resolve ItemsAdderAdditions custom tags.
