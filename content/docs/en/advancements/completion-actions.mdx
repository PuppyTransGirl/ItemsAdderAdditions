...
description: Configure sound, title, action bar, and command actions that fire when a player completes a custom ItemsAdder advancement. All types can be combined.
version: "1.0.9"
---
