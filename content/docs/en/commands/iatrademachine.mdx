...
description: Open an ItemsAdder trade machine GUI for a player.
version: "1.0.7"
---
...
The ID of the custom block or furniture that has a `trade_machine` or `block_trade_machine` behaviour. See [IDs](/en/docs/compatibility/ids).
