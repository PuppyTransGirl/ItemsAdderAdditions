---
title: Bed
description: Turn any ItemsAdder custom furniture into a functional multi-slot bed. Supports two players sleeping simultaneously on a single piece of furniture.
version: "1.0.7"
---
...
`"1,0,0"` is always one block in front of the base, regardless of which direction the furniture was placed.
...
![Bed Example](/assets/behaviours_bed_example.webp)