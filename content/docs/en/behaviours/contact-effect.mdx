...
description: Apply effects to players touching an ItemsAdder custom block or furniture. Supports damage, healing, potion effects, and temporary attribute modifiers, each with its own interval.
version: "1.0.10"
---
