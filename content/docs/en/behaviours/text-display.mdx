---
title: Text Display
description: Show floating text above custom blocks or furniture.
version: "1.0.8"
---

Attaches one or more floating text displays to a custom block or furniture. Supports MiniMessage formatting, [PlaceholderAPI](/en/docs/compatibility/placeholderapi) placeholders, and ItemsAdder font images.
