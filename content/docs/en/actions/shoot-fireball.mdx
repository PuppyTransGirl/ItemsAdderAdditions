...
description: Shoot a configurable fireball from a player or entity when an ItemsAdder item event fires. Set power, speed, and explosion yield in your YAML config.
version: "1.0.2"
---
