---
title: Replace Biome
description: Change vanilla or datapack biomes in a configured area.
version: "1.0.7"
---
...
Locations where the player does not have build permission (checked via [AntiGriefLib](/en/docs/compatibility/antigrieflib)) are skipped silently. Supported plugins include WorldGuard, GriefPrevention, Towny, GriefDefender, RedProtect, and others supported by AntiGriefLib.
...
- [AntiGriefLib compatibility](/en/docs/compatibility/antigrieflib)
