...
Locations where the player does not have build permission (checked via [AntiGriefLib](https://github.com/Xiao-MoMi/AntiGriefLib)) are skipped silently. Supported plugins include WorldGuard, GriefPrevention, Towny, GriefDefender, RedProtect, and others supported by AntiGriefLib.
