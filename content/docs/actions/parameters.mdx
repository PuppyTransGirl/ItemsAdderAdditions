...
description: Universal parameters shared by every ItemsAdderAdditions action. Control permission gating, execution delays, and entity targeting for any action.
---
