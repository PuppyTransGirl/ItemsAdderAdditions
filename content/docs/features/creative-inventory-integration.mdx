...
<Callout type="error">
  **Important:** To see and access the ItemsAdder items inside the creative inventory, you **must have access to the Operator Utilities tab**.
  This requires you to have operator permissions on the server and have the "Operator Items Tab" toggled **ON** in your Minecraft client's control settings.
</Callout>
