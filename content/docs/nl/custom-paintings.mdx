...
| `item` | `namespace:item_id` | *(geen)* | Optioneel gekoppeld ItemsAdder-item. Wanneer er met rechts op een geldig muurvlak wordt geklikt, plaatst dit item het aangepaste schilderij. Zie [ID's](/nl/docs/compatibility/ids). |
...
- WorldGuard-vlaggen voor painting placement worden gerespecteerd wanneer WorldGuard-integratie is ingeschakeld.
