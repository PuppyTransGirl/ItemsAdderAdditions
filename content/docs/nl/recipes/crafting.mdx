...
Ingrediënten kunnen daarnaast vanilla tags gebruiken zoals `#minecraft:planks`. Dit zijn alleen Bukkit vanilla item-/bloktags; ItemsAdderAdditions custom tags worden niet opgelost in craftingingrediënten. Tags zijn niet geldig als resultaat of vervangingsitem.
