...
Optioneel. Vanaf versie 1.0.13 beschikbaar voor beschadigbare resultaatitems.

Stelt de **resterende duurzaamheid** van het resultaat in, niet de schadewaarde. De waarde moet tussen `0` en de
maximale duurzaamheid van het item liggen. Een aangepaste maximale duurzaamheid die via resultaatcomponents is
toegepast wordt ook gerespecteerd.
