---
title: Werkbank
description: Voeg geavanceerde werkbankrecepten toe met ItemsAdder-items, MMOItems-items, vanilla items, vanilla tags, exacte aantallen, duurzaamheidsvereisten en shapeless recepten.
version: "1.0.10"
---
