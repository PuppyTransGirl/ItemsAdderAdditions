...
Je kunt ook één getal gebruiken als minimale valafstand:
...
Wordt geactiveerd wanneer de speler een specifiek bioom binnenstapt.
...
Wordt geactiveerd wanneer een speler van buiten naar binnen een WorldGuard-regio loopt of teleporteert.

<Callout type="warn">
    **Versievereisten:** Vereist **ItemsAdderAdditions 1.0.12 of hoger** en WorldGuard.
</Callout>
...
| Sleutel | Type | Standaard | Beschrijving |
|---------|------|-----------|--------------|
| `region` | string | *(vereist)* | WorldGuard-regio-ID. Hoofdletters worden genegeerd. |
| `world` | string | *(elke)* | Bukkit-wereldnaam om de controle tot één wereld te beperken. |

Het criterium wordt alleen geactiveerd bij het overschrijden van de regiogrens. Bewegen terwijl de speler al binnen de regio is activeert het niet opnieuw. Deze trigger staat los van de ItemsAdderAdditions WorldGuard-vlagopties.

Zie [WorldGuard-compatibiliteit](/nl/docs/compatibility/worldguard) voor installatie en probleemoplossing.
