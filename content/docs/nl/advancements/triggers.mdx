...
Een voortgang kan meerdere criteria hebben. Alle moeten worden voltooid voordat de voortgang wordt toegekend. Itemvoorwaarden accepteren ItemsAdder-ID's, MMOItems-ID's, vanilla ID's en vanilla itemtags. Blokvoorwaarden accepteren ItemsAdder-blok-ID's, vanilla blok-ID's en vanilla bloktags.
