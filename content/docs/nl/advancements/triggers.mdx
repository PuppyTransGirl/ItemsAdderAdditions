---
title: Triggers
description: Referentie voor alle ingebouwde triggertypen voor aangepaste ItemsAdder-voortgangen, inclusief voorwaarden en YAML-voorbeelden voor elk type.
version: "1.0.9"
---
...
|-----|------|---------|-------------|
| `items` | lijst van strings | `[]` | Item-ID's (IA, MMOItems of vanilla). Elke overeenkomst activeert het criterium. |
...
|-----|------|----------|-------------|
| `item` | string | ja | Item-ID (IA, MMOItems of vanilla). |
...
| Sleutel | Type | Standaard | Beschrijving |
|-----|------|---------|-------------|
| `item` | string | *(vereist)* | Item-ID (IA, MMOItems of vanilla) die de speler moet vasthouden. |
...
| Sleutel | Type | Standaard | Beschrijving |
|-----|------|---------|-------------|
| `item` | string | *(elke)* | Item-ID die de speler moet vasthouden. |
...
|-----|------|---------|-------------|
| `entity_type` | string | *(elke)* | Vanilla-entiteitstypesleutel. Indien weggelaten, komt elke entiteit overeen. |
| `item` | string | *(elke)* | Item-ID die de speler moet vasthouden. Indien weggelaten, komt elk item (of lege hand) overeen. |
