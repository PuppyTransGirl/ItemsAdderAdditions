...
description: Configureer geluid-, titel-, actionbar- en opdrachtacties die worden geactiveerd wanneer een speler een aangepaste ItemsAdder-voortgang voltooit. Alle typen kunnen worden gecombineerd.
version: "1.0.9"
---
...
| `as_console` | boolean | `false` | Voer uit als console. Wanneer `false`, voert de speler het commando uit met zijn eigen rechten. |
