...
description: Definieer aangepaste Minecraft-voortgangsbomen in uw ItemsAdder YAML-bestanden, met aangepaste triggers, nieuwe tabbladen en voltooiingsacties.
version: "1.0.9"
---
...
- Gebruik **24 ingebouwde triggertypen** (object verkrijgen, recept maken, entiteit doden, bioom betreden, dieren fokken, en meer)
...
<Callout>
    Alle voortgangen in een bestand delen dezelfde `info.namespace`. Ouders van verschillende naamruimten worden
    ondersteund met het formaat `namespace:id`.
</Callout>
