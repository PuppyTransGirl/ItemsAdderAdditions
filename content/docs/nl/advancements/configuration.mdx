...
| `criteria` | section | *(geen)* | Voorwaarden die moeten worden vervuld om de voortgang te voltooien. Zie [Triggers](/docs/advancements/triggers). |
...
| `background` | string | *(geen)* | **Alleen hoofdvoortgangen.** Tekstuurpad voor de tabblad-achtergrond (bijv. `minecraft:gui/advancements/backgrounds/adventure.png`). |
