...
<Callout>
    Advancements met meerdere criteria (zoals `master_crafter` hierboven) vereisen dat alle criteria worden voltooid. Elk criterium wordt onafhankelijk bijgehouden en de voortgang wordt door vanilla opgeslagen. Sinds ItemsAdderAdditions 1.0.12 behoudt `/iareload` de bestaande registraties en voortgang wanneer de definities ongewijzigd zijn. Een gewijzigde definitie kan opnieuw geregistreerd moeten worden.
</Callout>
