...
Craftingreceptingrediënten zijn anders: `iaa_crafting_table` tag-ingrediënten gebruiken alleen Bukkit's vanilla item-/bloktags. Ze lossen geen ItemsAdderAdditions custom tags op.
