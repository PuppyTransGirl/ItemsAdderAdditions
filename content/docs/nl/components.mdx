...
Stelt de begininhoud van een bundelitem in. Accepteert vanilla-IDs, ItemsAdder-IDs, en het `mmoitems:TYPE:ID`-formaat. Zie [compatibiliteit](/nl/docs/compatibility) voor volledige formaatdetails.
...
Stelt de voorgeladen projectielen in een kruisboog in. Accepteert vanilla-IDs, ItemsAdder-IDs, en het `mmoitems:TYPE:ID`-formaat.
...
Accepteert vanilla-IDs, ItemsAdder-IDs, en het `mmoitems:TYPE:ID`-formaat.
