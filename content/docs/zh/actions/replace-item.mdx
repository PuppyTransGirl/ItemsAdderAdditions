...
必填。要给予玩家的替换物品。可使用[此列表](https://jd.papermc.io/paper/org/bukkit/inventory/ItemType.html#field-summary)中的原版材质、使用 `命名空间:id` 或仅 `id` 的自定义 ItemsAdder 物品，或使用 `mmoitems:type:id` 的 MMOItems 物品
