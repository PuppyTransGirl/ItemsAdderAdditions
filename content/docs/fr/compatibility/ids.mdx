...
Les ingrédients de `iaa_crafting_table` sont un cas particulier : les ingrédients sous forme de tag utilisent uniquement les tags Bukkit vanilla d'objets/blocs. Ils ne résolvent pas les tags personnalisés ItemsAdderAdditions.
