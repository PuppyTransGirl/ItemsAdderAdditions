...
Les ingrédients de recettes de craft sont différents : les ingrédients sous forme de tag de `iaa_crafting_table` utilisent uniquement les tags Bukkit vanilla d'objets/blocs. Ils ne résolvent pas les tags personnalisés ItemsAdderAdditions.
