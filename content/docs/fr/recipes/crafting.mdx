...
description: Ajouter des recettes avancées avec objets ItemsAdder, objets MMOItems, objets vanilla, tags vanilla, quantités exactes, conditions de durabilité et recettes shapeless.
version: "1.0.7"
---
