...
description: Ajouter des recettes avancées de table de craft ItemsAdder avec tags d’ingrédients, quantités exactes, conditions de durabilité et prise en charge des recettes shapeless.
version: "1.0.7"
---
...
Prend en charge les matériaux vanilla et les objets ItemsAdder.
