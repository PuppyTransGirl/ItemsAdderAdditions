...
| `item` | `namespace:item_id` | *(aucun)* | Objet ItemsAdder lié optionnel. Quand on clique droit sur une face de mur valide, cet objet permet de placer le tableau personnalisé. |
