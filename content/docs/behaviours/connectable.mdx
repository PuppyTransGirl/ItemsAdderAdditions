...
<Tabs items={['Stair type', 'Table type']}>
  <Tab value="Stair type">
    ...
    ![Connectable Stair type Example](/images/behaviours_connectable_stair_type_example.gif)
  </Tab>
  <Tab value="Table type">
    ...
    ![Connectable Table type Example](/images/behaviours_connectable_table_type_example.gif)
  </Tab>
</Tabs>
