...
description: Make ItemsAdder custom blocks and furniture deal damage to players that touch them. Configure damage amount, tick interval, and optional potion effects like poison or wither - all in your existing YAML.
---
