---
title: Stackable
description: Allow ItemsAdder custom blocks to stack on top of each other. Define which blocks can stack together and set stacking limits - configured inside your existing YAML item definitions.
---
